  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 md:gap-8">
        ...
        <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-6 space-y-8 flex flex-col">
          <div>
          ...
          <div className="mt-auto pt-8 border-t border-slate-100">
            <h4 className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-6">Network SLA Adherence</h4>
            <div className="flex items-center gap-6">
               <div className="flex-1">
                  <div className="text-2xl font-black text-slate-900">99.2%</div>
                  <div className="text-[10px] text-emerald-500 font-bold uppercase tracking-tight">On Track</div>
               </div>
